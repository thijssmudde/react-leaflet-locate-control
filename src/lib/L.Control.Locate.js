    ...
    var LocateControl = L
        ...
        .extend({
            options: {
                ...
                createButtonCallback: function (container, options) {
                    var link = L
                        .DomUtil
                        .create('a', 'leaflet-bar-part leaflet-bar-part-single', container)
                    link.title = options.strings.title
                    var icon = L
                        .DomUtil
                        .create(options.iconElementTag, options.iconInactive || options.icon, link)
            ...
            */
            onAdd: function (map) {
                var container = L
                    .DomUtil
                    .create('div', 'leaflet-control-locate leaflet-bar leaflet-control')
                ...
                var linkAndIcon = this
                    .options
                    .createButtonCallback(container, this.options)
            ...
            */
            _activate: function () {
                if (!this._active) {
                    ...
                    this
                        ._map
                        .locate(this.options.locateOptions)
                    this._active = true
                    ...
                    this
                        ._map
                        .on('dragstart', this._onDrag, this)
                }
            },
            ...
            */
            setView: function () {
                ...
                if (this._isOutsideMapBounds()) {
                    ...
                    this
                        .options
                        .onLocationOutsideMapBounds(this)
                } else {
            ...
            */
            _drawMarker: function () {
                ...
                if (this.options.drawMarker) {
                    ...
                    if (!this._marker) {
                        this._marker = new this
                            .options
                            .markerClass(latlng, mStyle)
                            .addTo(this._layer)
                    } else {
                        this
                            ._marker
        ...
        */
            _isOutsideMapBounds: function () {
                ...
                return this._map.options.maxBounds && !this
                    ._map
                    .options
                    .maxBounds
                    .contains(this._event.latlng)
        ...
        */
            _setClasses: function (state) {
                if (state == 'requesting') {
                    ...
                    removeClasses(this._icon, this.options.iconInactive ? this.options.iconInactive + " " + this.options.icon : this.options.icon);
        ...
        */
            _cleanClasses: function () {
                L
                    .DomUtil
                    .removeClass(this._container, 'requesting')
                L
                    .DomUtil
                ...
                removeClasses(this._icon, this.options.iconInactive ? this.options.icon + " " + this.options.iconLoading : this.options.iconLoading);
                addClasses(this._icon, this.options.iconInactive || this.options.icon)
            },
